...
describe("About Applying What We Have Learnt", function() {
  ...
  it("given I'm allergic to nuts and hate mushrooms, it should find a pizza I can eat (functional)", function() {
    ...
    productsICanEat = _(products).filter(function(noNutsNoMushrooms) {
      return noNutsNoMushrooms.containsNuts === false && !_(noNutsNoMushrooms.ingredients).any(function(noMushrooms) {
        return noMushrooms === 'mushrooms';
      })
    })
  ...
  it("should add all the natural numbers below 1000 that are multiples of 3 or 5 (functional)", function() {
    ...
    var arr = _.range(0, 1000)
    var sum = _(arr).chain()
      .reduce(function(num, i) {
        if (i % 3 === 0 || i % 5 === 0) {
          return num += i;
        } else {
          return num;
